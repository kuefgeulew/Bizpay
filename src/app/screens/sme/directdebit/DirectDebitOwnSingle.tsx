...
interface DirectDebitOwnSingleProps {
  onBack: () => void;
}

export default function DirectDebitOwnSingle({ onBack }: DirectDebitOwnSingleProps) {
  ...
  // GOVERNANCE_ENFORCEMENT — Direct Debit Execution Gate
  function handleSubmitInstruction() {
    const numAmount = parseFloat(ddAmount) || 0;
    const result = enforceTransactionGate({
      amount: numAmount,
      category: "DIRECT_DEBIT",
      description: "Direct Debit — Own Account Single",
    });
  ...
  return (
    <div className="relative h-full text-white px-6 pt-8 overflow-y-auto pb-24 font-sans">
      ...
      <header className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-3xl font-serif tracking-tight">Collect from Own A/C</h1>
        ...
        <div className="space-y-5">
          ...
          <Field label="Amount (BDT) *">
            <input
              ...
              value={ddAmount}
              onChange={(e) => { setDdAmount(e.target.value); setEnforcementResult(null); }}
            />
          </Field>
